...
public static class Utility
{
    ...
    public static void StaticObjects()
    {
        ...
        var cameras = Object.FindObjectsByType<CinemachineVirtualCamera>(FindObjectsSortMode.None);
        ...
        var carts = Object.FindObjectsByType<CinemachineDollyCart>(FindObjectsSortMode.None);
